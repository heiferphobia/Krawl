...
public class TriangleDT {
	PointDT a,b,c;
	TriangleDT abnext,bcnext,canext;
	CircleDT circum;
...
/*	protected void finalize() throws Throwable{
  ...
  CircleDT circumcircle() {
    ...
    if ( den==0 ) // oops, degenerate case
      ...
      PointDT cen =  new PointDT((u*(b.y-c.y) - v*(a.y-b.y)) / den,
